    ...
    return (
        <div className="p-4 md:p-10 max-w-4xl mx-auto space-y-6 md:space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000 uppercase font-sans tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {/* Identity Card */}
                <Card className="border-none shadow-2xl rounded-2xl md:rounded-[3rem] bg-card overflow-hidden p-6 md:p-10 ring-1 ring-border">
                    <div className="flex flex-col items-center text-center">
                        <div className="h-20 w-20 md:h-28 md:w-28 rounded-2xl md:rounded-[2.5rem] bg-slate-900 shadow-2xl mb-4 md:mb-6 flex items-center justify-center overflow-hidden border-4 border-muted">
                        ...
                        <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-border w-full space-y-3 md:space-y-4 text-left">
                            <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl md:rounded-2xl bg-muted border border-border">
                                <div className="h-9 w-9 md:h-10 md:w-10 rounded-lg md:rounded-xl bg-card border border-border flex items-center justify-center text-muted-foreground shrink-0">
                ...
                <div className="space-y-4 md:space-y-6">
                    <Card className="border-none shadow-xl rounded-2xl md:rounded-[2.5rem] p-6 md:p-8 bg-slate-900 text-white flex flex-col justify-between h-full">
                        <div>
                        ...
                        <div className="mt-8 md:mt-10 space-y-2 md:space-y-3">
                            <Button className="w-full rounded-xl md:rounded-2xl h-12 md:h-14 font-black uppercase text-[10px] md:text-[11px] tracking-widest gap-2 bg-white text-slate-900 hover:bg-slate-100 shadow-xl border-none">
                            ...
                            <Button 
                                ...
                                variant="outline" 
                                className="w-full rounded-xl md:rounded-2xl h-12 md:h-14 font-black uppercase text-[10px] md:text-[11px] tracking-widest gap-2 border-red-500/30 bg-transparent text-red-500 hover:bg-red-500 hover:text-white transition-all duration-300"
                            >
