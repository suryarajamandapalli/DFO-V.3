        ...
        <div className="p-4 md:p-6 space-y-4 md:space-y-6 relative">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 no-print">
                ...
                <div className="flex items-center gap-3">
                    <Button variant="outline" size="sm" onClick={() => refreshConsultations()} className="rounded-xl border-border font-bold uppercase text-[10px] tracking-widest gap-2 h-10 px-4 w-full sm:w-auto">
                        ...
                        <div className="mt-12 space-y-12">
                            ...
                            <section className="grid grid-cols-2 gap-12">
                                ...
                                <div>
                                    ...
                                    <div className="inline-flex items-center px-4 py-2 bg-slate-950 text-white rounded-xl text-xs font-black uppercase tracking-widest">
