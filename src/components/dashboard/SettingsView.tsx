    ...
    return (
        <div className="p-4 md:p-10 max-w-5xl mx-auto space-y-6 md:space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                {/* Theme Selection */}
                <Card className="border-none shadow-2xl rounded-2xl md:rounded-[3rem] bg-card p-6 md:p-10 ring-1 ring-border">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            "flex flex-col items-center gap-3 p-4 rounded-3xl border-2 transition-all duration-300 flex-1",
                                            theme === t.id 
                                ...
                                <div className="flex gap-4">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                "h-10 w-10 rounded-2xl transition-all duration-300 ring-offset-4",
                                                c.color,
                                                accentColor === c.id ? "ring-2 ring-foreground scale-110 shadow-lg" : "scale-100"
                                            )}
                                        />
                                    ))}
                                </div>
