        ...
        <div className="p-4 md:p-6 space-y-4 md:space-y-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative flex-1 sm:w-64">
                        ...
                        <Input
                            ...
                            className="pl-9 rounded-xl border-border bg-card h-10"
                        />
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className={cn(
                    ...
                    {selectedLead ? (
                        <Card className="border-none shadow-xl rounded-2xl md:rounded-[2.5rem] sticky top-6 bg-card overflow-hidden ring-1 ring-primary/20">
                            <div className="h-20 md:h-24 bg-slate-900 relative">
                                ...
                                <div className="absolute -bottom-10 left-8">
                                    <div className="h-16 w-16 md:h-20 md:w-20 rounded-2xl md:rounded-3xl bg-card p-1 shadow-xl">
                                        <div className="h-full w-full rounded-[1rem] md:rounded-[1.25rem] bg-muted flex items-center justify-center border border-border">
                            ...
                            <CardContent className="pt-12 md:pt-14 pb-6 md:pb-8 px-5 md:px-8">
                                ...
                                <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                                    <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl md:rounded-2xl bg-muted border border-border group hover:border-primary/20 transition-all">
                                        <div className="h-9 w-9 md:h-10 md:w-10 rounded-lg md:rounded-xl bg-card border border-border flex items-center justify-center text-muted-foreground group-hover:text-primary">
                                    ...
                                    <div className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl md:rounded-2xl bg-muted border border-border">
                                        <div className="h-9 w-9 md:h-10 md:w-10 rounded-lg md:rounded-xl bg-card border border-border flex items-center justify-center text-muted-foreground">
                                ...
                                <div className="grid grid-cols-3 gap-2 md:gap-3 mb-6 md:mb-8">
                                    <Button 
                                        variant="outline" 
                                        className="flex-col h-16 md:h-20 rounded-xl md:rounded-2xl gap-1 md:gap-2 border-border hover:bg-sky-500/5 hover:border-sky-500/20 group text-foreground"
                                    >

                                        <div className="p-1.5 md:p-2 rounded-lg bg-sky-50 text-sky-600 mt-1">
                                    ...
                                    <Button 
                                        variant="outline" 
                                        className="flex-col h-16 md:h-20 rounded-xl md:rounded-2xl gap-1 md:gap-2 border-slate-100 hover:bg-emerald-50 hover:border-emerald-100"
                                        onClick={() => selectedLead.phone && triggerSmartCall(selectedLead.phone)}
                                    >
                                        <div className="p-1.5 md:p-2 rounded-lg bg-emerald-50 text-emerald-600 mt-1">
                                    ...
                                    <Button 
                                        variant="outline" 
                                        className="flex-col h-16 md:h-20 rounded-xl md:rounded-2xl gap-1 md:gap-2 border-slate-100 hover:bg-green-50 hover:border-green-100"
                                        onClick={() => selectedLead.phone && triggerWhatsApp(selectedLead.phone)}
                                    >
                                        <div className="p-1.5 md:p-2 rounded-lg bg-green-50 text-green-600 mt-1">
